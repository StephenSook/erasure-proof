...
def test_envelope_encrypts_and_erasure_makes_it_unrecoverable():
    ...
    # Erasure: the wrapped key is gone (deleted from the DB). There is no wrapped copy to decrypt,
    # so the data key is unrecoverable and the ciphertext is provable noise.
